...
CMAP_DATASET_COLUMNS = ["Session", "Filename", "Encryption key", "Tag", "Size"]
...
# External resources (git clone, tests dummies, etc.)
TEST_RESOURCES_ROOT_LOC = Path("./external_resources")

S3_SERVER_ENDPOINT = "https://s3.fr-lyo.jaguar-network.com/"
